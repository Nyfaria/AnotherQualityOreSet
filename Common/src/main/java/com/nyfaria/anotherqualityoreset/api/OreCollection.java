...
public record OreCollection(String name, RegistryObject<DropExperienceBlock> ore, RegistryObject<Item> rawOre,
                            ...
                            RegistryObject<TreeAxeItem> treeAxe) {
    ...
    public static OreCollection of(AQOArmoMaterials material, AQOToolTiers toolTier) {
        return OreCollection.of(
                ...
                ItemInit.ITEMS.register(material.getName() + "_helmet", () -> new AQOArmorItem(material, ArmorItem.Type.HELMET, ItemInit.getItemProperties())),
                ItemInit.ITEMS.register(material.getName() + "_chestplate", () -> new AQOArmorItem(material, ArmorItem.Type.CHESTPLATE, ItemInit.getItemProperties())),
                ItemInit.ITEMS.register(material.getName() + "_leggings", () -> new AQOArmorItem(material, ArmorItem.Type.LEGGINGS, ItemInit.getItemProperties())),
                ItemInit.ITEMS.register(material.getName() + "_boots", () -> new AQOArmorItem(material, ArmorItem.Type.BOOTS, ItemInit.getItemProperties())),
    ...
    public static OreCollection of(String name, RegistryObject<DropExperienceBlock> ore, RegistryObject<Item> raw_ore, RegistryObject<Block> rawOreBlock, RegistryObject<Item> ingot, RegistryObject<Item> nugget, RegistryObject<Block> block, RegistryObject<ArmorItem> helmet, RegistryObject<ArmorItem> chestplate, RegistryObject<ArmorItem> leggings, RegistryObject<ArmorItem> boots, RegistryObject<SwordItem> sword, RegistryObject<PickaxeItem> pickaxe, RegistryObject<AxeItem> axe, RegistryObject<HoeItem> hoe, RegistryObject<ShovelItem> shovel, RegistryObject<PaxelItem> paxel, RegistryObject<HammerItem> hammer, RegistryObject<TreeAxeItem> treeAxe) {
        ...
        return new OreCollection(name, ore, raw_ore, rawOreBlock, ingot, nugget, block, helmet, chestplate, leggings, boots, sword, pickaxe, axe, hoe, shovel, paxel, hammer, treeAxe);
    }
