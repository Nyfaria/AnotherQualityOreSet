...
public class OreCollection {
    ...
    public static OreCollection of(AQOArmoMaterials material, Tier toolTier) {
        return new OreCollection(
                ...
                ItemInit.ITEMS.register(material.getName() + "_helmet", () -> new ArmorItem(material, EquipmentSlot.HEAD, ItemInit.getItemProperties())),
                ItemInit.ITEMS.register(material.getName() + "_chestplate", () -> new ArmorItem(material, EquipmentSlot.CHEST, ItemInit.getItemProperties())),
                ItemInit.ITEMS.register(material.getName() + "_leggings", () -> new ArmorItem(material, EquipmentSlot.LEGS, ItemInit.getItemProperties())),
                ItemInit.ITEMS.register(material.getName() + "_boots", () -> new ArmorItem(material, EquipmentSlot.FEET, ItemInit.getItemProperties())),
