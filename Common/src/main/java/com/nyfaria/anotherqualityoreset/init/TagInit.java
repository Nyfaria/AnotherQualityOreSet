...
public class TagInit {
    ...
    public static final TagKey<Block> NEEDS_TOOL_LEVEL_4 = TagKey.create(Registry.BLOCK_REGISTRY,new ResourceLocation("fabric", "needs_tool_level_4"));

    public static TagKey<Block> blockTag(String path) {
        return TagKey.create(Registry.BLOCK_REGISTRY,new ResourceLocation(Constants.MODID, path));
    }
